...
class Smarty_Internal_Compile_Foreach extends Smarty_Internal_Compile_Private_ForeachSection
{
     ...
     * @var array
     */
    public $nameProperties = array('first', 'last', 'cate', 'iteration', 'show', 'total');
     ...
     * @var array
     */
    public $itemProperties = array('first', 'last', 'cate', 'iteration', 'show', 'total', 'key');
    ...
    public function compile($args, Smarty_Internal_TemplateCompilerBase $compiler)
    {
        ...
        if (isset($itemAttr[ 'cate' ])) {
            $output .= "{$itemVar}->cate = -1;\n";
        }
        ...
        if (isset($itemAttr[ 'first' ])) {
            $output .= "{$itemVar}->first = !{$itemVar}->cate;\n";
        }
        if (isset($itemAttr[ 'last' ])) {
        ...
        if (isset($foreachVar)) {
            ...
            if (isset($namedAttr[ 'cate' ])) {
                $output .= "{$foreachVar}->value['cate']++;\n";
            }
            if (isset($namedAttr[ 'first' ])) {
                $output .= "{$foreachVar}->value['first'] = !{$foreachVar}->value['cate'];\n";
            }
            if (isset($namedAttr[ 'last' ])) {
