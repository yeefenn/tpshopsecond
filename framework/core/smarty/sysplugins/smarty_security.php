...
class Smarty_Security
{
    ...
    /**
     * Remove old directories and its sub folders, cate new directories
     *
     * @param array $oldDir
     * @param array $newDir
     */
    ...
    private function _checkDir($filepath, $dirs)
    {
        ...
        if (!preg_match('#[\\\\/][.][.][\\\\/]#', $directory)) {
            while (true) {
                ...
                // remember the directory to cate it to _resource_dir in case we're successful
