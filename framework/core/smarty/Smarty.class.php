    ...
    */
    ...
    public function addTemplateDir($template_dir, $key = null, $isConfig = false)
    {
        ...
        if (is_array($template_dir)) {
            ...
            if ($key !== null) {
                // override directory at specified cate
     ...
     *
     * @param mixed $index    cate of directory to get, null to get all
     * @param bool  $isConfig true for config_dir
     *
     * @return array list of template directories, or directory of $cate
     */
